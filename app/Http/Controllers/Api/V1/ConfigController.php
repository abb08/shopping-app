...
class ConfigController extends Controller
{
        public function geocode_api(Request $request)
    {
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='."AIzaSyDEvUX2m4bWnunEVNiekGHzWv_wksv779c");
    ...
    .$request['search_text']
    .'&key='
    .'AIzaSyDEvUX2m4bWnunEVNiekGHzWv_wksv779c'
    );
    return $response->json();
