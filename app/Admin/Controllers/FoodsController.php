...
class FoodsController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('img', __('Thumbnail Photo'))->display(function ($img) {
            // Patch in 'uploads/' if it's missing
            $path = str_starts_with($img, 'uploads/') ? $img : 'uploads/' . $img;
            return "<img src='" . asset($path) . "' style='width:60px;height:60px;' />";
        });
